...
- **Estilização e Design System (Nocturne Calibrado):** Tailwind CSS v4 com sistema visual definitivo **Nocturne**, adaptado com rigor WCAG 2.2 AA:
  ...
  - **Feedback tátil mobile (:active):** Resposta imediata ao toque (~100–150ms, nominal 120ms) via micro-escala (`scale(0.97)`) e realce de fundo em todos os botões, cards, tabs e links, sem substituir nem alterar os estados de `:hover` existentes para desktop.
